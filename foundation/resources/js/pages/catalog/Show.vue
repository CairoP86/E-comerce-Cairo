...
import { catalogUrl, type PublicProduct, type Seo } from '../../types/storefront';
const props = defineProps<{ product: PublicProduct; related: PublicProduct[]; seo: Seo }>();
