...
<template>
    <StoreSeo :seo="seo"/><StoreLayout>
        ...
        <ProductSection title="Una mirada a los precios especiales." eyebrow="OFERTAS DE DEMOSTRACIÓN" :products="offers" :availability="availability" href="/catalog?offers=1"/>
