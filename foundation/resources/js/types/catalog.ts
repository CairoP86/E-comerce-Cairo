...
export interface Taxonomy { id: number; name: string; slug: string; description: string | null; status: CatalogStatus; parent_id?: number | null; is_demo?: boolean; depth?: number; products_direct?: number; products_total?: number; pricing?: { units: number; rule: string; inherited: boolean; from: string | null } | null }
